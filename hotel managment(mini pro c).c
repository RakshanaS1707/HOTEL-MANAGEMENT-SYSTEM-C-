...
{     // MAIN FUNCTION	
	...
	printf("\t\t*       -----------------------------           *\n");
	printf("\t\t*        WELCOME TO KURUMBA LAKE RESORT         *\n");
	printf("\t\t*       -----------------------------           *\n");
		for(i=0;i<80;i++)
		printf("-");
...
void about_us()
{
         ...
         printf("is the memorable experience you could enjoy only at KURUMBA LAKE RESORT. \n");         
...
void feed_back()
	 ...
	 {         
	 printf("please enter your feed_back \n");     
	 fflush(stdin);     
	 gets(feed_back);     
